...
The portfolio consumes `@johnnyzli/web-design-system` v1.3.2 from the exact source commit recorded in `package.json` and `assets/design-system/SOURCE.md`.
...
Product-specific editorial layout remains in this repository. Shared colors, typography roles, focus behavior, canvas texture, spacing primitives, and site-identity foundations come from the design-system package.
